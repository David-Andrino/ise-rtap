...
\input{files/2-Subsistemas/2-1-Alimentacion.tex}
\input{files/2-Subsistemas/2-2-Audio.tex}
\input{files/2-Subsistemas/2-3-Radio.tex}
\input{files/2-Subsistemas/2-4-MP3.tex}
\input{files/2-Subsistemas/2-5-NFC.tex}
\input{files/2-Subsistemas/2-6-Entre-Dos-Tierras.tex}
\input{files/2-Subsistemas/2-7-Alimentar-Placa.tex}
