...
c m a                     <option value="%s">%s</option>
c m b                     <option value="%s">%s</option>
c m c                     <option value="%s">%s</option>
c m d                     <option value="%s">%s</option>
c m e                     <option value="%s">%s</option>
c m f                     <option value="%s">%s</option>
c m g                     <option value="%s">%s</option>
c m h                     <option value="%s">%s</option>
c m i                     <option value="%s">%s</option>
c m j                     <option value="%s">%s</option>
c m k                     <option value="%s">%s</option>
c m l                     <option value="%s">%s</option>
c m m                     <option value="%s">%s</option>
c m n                     <option value="%s">%s</option>
c m o                     <option value="%s">%s</option>
c m p                     <option value="%s">%s</option>
c m q                     <option value="%s">%s</option>
c m r                     <option value="%s">%s</option>
c m s                     <option value="%s">%s</option>
c m t                     <option value="%s">%s</option>
c m u                     <option value="%s">%s</option>
c m v                     <option value="%s">%s</option>
c m w                     <option value="%s">%s</option>
c m x                     <option value="%s">%s</option>
c m y                     <option value="%s">%s</option>
t                     </select>
